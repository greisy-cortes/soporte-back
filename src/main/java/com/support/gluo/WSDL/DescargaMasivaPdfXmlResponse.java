...
/**
 * <p>Clase Java para descargaMasivaPdfXmlResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="descargaMasivaPdfXmlResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "descargaMasivaPdfXmlResponse", propOrder = {
    "_return"
})
public class DescargaMasivaPdfXmlResponse {
